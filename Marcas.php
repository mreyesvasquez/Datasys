    ...
    <body>
        <div id="todo">
            ...
            <div id="cuerpo">
                ...
                <div id="Datos">
                    <form action="Mantenedores/MarcasGuardar.php" method="get" name="frmMarcas" onSubmit="validarMarcas(); return false">
                        <fieldset>
                        <table border="0">
                            <tr>
                                <td Style="height:40px; width: 30px"></td>
                                <td>Marca:</td>
                                <td style="height: 40px"><input type="text" name="txtmarcas" size="40" placeholder=" Ingresar Nueva Marca"></td>
                            </tr>
                        </table>
                        </fieldset>
                        <br>
                ...
                <div id="MostrarDatos">
                    ...
                    <table align="center" border="0" CELLSPACING="7" CELLPADDING="7" style="font-size: 12px;font-family: verdana;background: #c0c0c0;">
                        ...
                        <tr style="background: #f0f0f0;">
                            <th ><?php echo $rsmarcas["idmarcas"] ?></th>
                            <td ><?php echo $rsmarcas["marcas"] ?></td>
                            <th><div align="center"><a href="MarcaEditar.php?id=<?php echo $rsmarcas["idmarcas"] ?>" class="enlace">Editar</a></div></th>
                        <?php } ?>
                        </tr>
                    </table>
                </div>
